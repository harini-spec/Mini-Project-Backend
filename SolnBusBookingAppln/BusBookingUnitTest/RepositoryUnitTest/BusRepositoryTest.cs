...
namespace BusBookingUnitTest.RepositoryUnitTest
{
    public class BusRepositoryTest
    {
        ...
        public void Setup()
        {
            DbContextOptionsBuilder optionsBuilder = new DbContextOptionsBuilder().UseInMemoryDatabase("BusRepoDB");
        ...
        {
            // Arrange
            IRepository<string, Bus> busRepository = new MainRepository<string, Bus>(context);
        ...
        public async Task GetByBusNumberFailureTest()
        {
            ...
            // Assert
            Assert.That(exception.Message, Is.EqualTo("Entity of type Bus with ID TN04A0000 not found."));
        }
